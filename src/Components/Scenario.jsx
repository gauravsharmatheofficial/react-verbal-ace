...
function Scenario() {
  return (
    <div className="container">
      <p className="section-subtitle">Popular Scenario</p>
      <h2 className="h2 section-title">Pick A Scenario To Get Started</h2>
      <ul className="grid-list">
        <li>
          <div className="course-card">
            ...
            >
              <img
                src="src/assets/images/course-1.jpg"
                style={{ width: "370px", height: "220px", loading: "lazy" }}
        ...
        <li>
          <div className="course-card">
            ...
            >
              <img
                src="src/assets/images/course-2.jpg"
                style={{ width: "370px", height: "220px", loading: "lazy" }}
        ...
        <li>
          <div className="course-card">
            ...
            >
              <img
                src="src/assets/images/course-3.jpg"
                style={{ width: "370px", height: "220px", loading: "lazy" }}
      ...
      <a href="#" className="btn has-before">
        <span className="span">Browse more Scenario</span>
